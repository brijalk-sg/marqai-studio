...
export const ContentStudio = () => {
  ...
  const renderContentEditor = () => {
    ...
    const eeatAvg = (Object.values(brief.eeatBreakdown).reduce((s, e) => s + e.score, 0) / 4).toFixed(1);
          ...
          <div>
            ...
            {editorTab === "article" && (
              <div style={{ ...css.card, padding: 20 }}>
                ...
                {brief.article.content && brief.article.content.split("\n\n").map((para, i) => {
                ...
                {brief.outline.sections.slice(2).map((s, i) => (
            ...
            {editorTab === "eeat" && (
              <div>
                ...
                {Object.values(brief.eeatBreakdown).map((item) => {
            ...
            {editorTab === "meta" && (
              <div style={{ ...css.card, padding: 18 }}>
                {[{ l: "Title Tag", v: brief.meta.title, c: brief.meta.title.length }, { l: "Meta Description", v: brief.meta.description, c: brief.meta.description.length }, { l: "OG Title", v: brief.meta.og_title, c: null }].map((f) => (
                  <div key={f.l} style={{ marginBottom: 16 }}>
                    <label style={{ fontSize: 10, fontWeight: 700, color: "#475569", textTransform: "uppercase", display: "block", marginBottom: 5 }}>{f.l} {f.c && <span style={{ color: f.c > 60 && f.c < 100 ? "#10b981" : "#f59e0b", fontWeight: 500, textTransform: "none" }}>({f.c} chars)</span>}</label>
            ...
            {editorTab === "outline" && (
              <div style={{ ...css.card, padding: 18 }}>
                ...
                {brief.outline.sections.map((s, i) => (
                  <div key={i} style={{ display: "flex", alignItems: "center", gap: 10, padding: "9px 12px", borderRadius: 7, border: "1px solid rgba(255,255,255,0.05)", background: "rgba(255,255,255,0.01)", marginBottom: 5 }}>
